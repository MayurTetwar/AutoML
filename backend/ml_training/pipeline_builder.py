    ...
    try:
        ...
        for col, steps in preprocess_plan.items():
            try:
                ...
                print(f"[build_pipeline] ERROR processing column '{col}' plan: {type(e).__name__}: {str(e)}")
                raise
        ...
        try:
            ...
            for col in X.columns:
                try:
                    ...
                    print(f"[DatetimeTransformer.transform] ERROR processing column '{col}': {type(e).__name__}: {str(e)}")
                    raise
            return result.values
        except Exception as e:
            print(f"[DatetimeTransformer.transform] FATAL ERROR: {type(e).__name__}: {str(e)}")
            raise