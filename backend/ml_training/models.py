...
def _build_best_regressor(model_name, params, preprocessor):
    ...
    try:
        ...
        print(f"[_build_best_regressor] ERROR building {model_name}: {type(e).__name__}: {str(e)}")
        raise
...
def _build_best_classifier(model_name, params, preprocessor, weight):
    ...
    try:
        ...
        print(f"[_build_best_classifier] ERROR building {model_name}: {type(e).__name__}: {str(e)}")
        raise